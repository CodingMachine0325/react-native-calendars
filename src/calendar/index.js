...
const Calendar = (props) => {
    ...
    const renderDay = (day, id) => {
        ...
        return (<TouchableOpacity style={style.current.dayContainer} key={id}>
    ...
    const renderMonth = () => {
        ...
        return <TouchableOpacity style={style.current.monthView} activeOpacity={1}>{weeks}</TouchableOpacity>;
    };
    ...
    <GestureComponent {...gestureProps}>
      <TouchableOpacity style={[style.current.container, propsStyle]} testID={testID} accessibilityElementsHidden={accessibilityElementsHidden} // iOS
